<template>
  <section class="searchHome">
    ...
    <div class="order_cell row">
      ...
      <div style="width:100%;">
        <searchItem :type="1" label="美食热推"></searchItem>
      </div>
      <div style="width:100%;margin-top:10px">
        <searchItem :type="2" label="天天特价"></searchItem>
      </div>
      <div style="width:100%;margin-top:10px">
        <searchItem :type="3" label="限时好礼"></searchItem>
      </div>
    </div>
  </section>
</template>
...
export default {
  name: "mineHome",
  components: {
    searchItem: r => { require(['./components/searchItem'], r) },
  },
  data() {
    return {
      list: [
